...
class Transaction:
    ...
    def by_month(self):
        ...
        return self.run_query('''SELECT item_num, amount, category, STRFTIME('%m',date) AS summarized_by, description 
                              FROM transactions 
    ...
    def add_transaction(self,item):
        ''' create a transactions item and add it to the transactions table ~abigailmurphy ~ariasmith'''
